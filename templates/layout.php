...
<?php $has_session = isset($_SESSION['user']) ?>
<body class="<?php if (!$has_session): ?>body-background<?php endif; ?>">
<h1 class="visually-hidden">Дела в порядке</h1>

<div class="page-wrapper">
    <div class="container <?php if ($has_session): ?>container--with-sidebar<?php endif; ?>">
            ...
            <div class="main-header__side">
                <?php if ($has_session): ?>
                    <a class="main-header__side-item button button--plus open-modal"
                       href="add-task.php<?php if (!empty($selected_project_id)): ?>?project_id=<?= $selected_project_id ?><?php endif; ?>">Добавить
                        задачу</a>
    ...
    <div class="container">
        ...
        <?php if ($has_session): ?>
            <a class="main-footer__button button button--plus"
               href="add-task.php<?php if (!empty($selected_project_id)): ?>?project_id=<?= $selected_project_id ?><?php endif; ?>">Добавить задачу</a>
        <?php endif; ?>
